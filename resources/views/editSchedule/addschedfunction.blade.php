                            ...
                            <div class="page-wrapper">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h5>Add Assessment Schedule</h5>
                                         
                                                
                                            </div>
                                            <div class="card-block">
                                            <form method="post" action="{{ URL::to('/addschedfunctions')}}">
                                              {{ csrf_field() }}
                                                    <div class="form-group row">
                                                        <label class="col-sm-2 col-form-label">Date of Assessment:</label>
                                                        <div class="col-sm-10">
                                                            <input type="date" class="form-control form-control-normal" name="schedule_date" required="" id="name" value="" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="number" class="form-control form-control-capitalize"name="schedule_no_of_candidates" required="" id="name" value=""  placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
