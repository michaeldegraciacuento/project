                        ...
                        <div class="main-body">
                            <div class="page-wrapper">
                                        ...
                                        <div class="card">
                                            ...
                                            <form method="post" action="{{ URL::to('/editresupdates/'.$res_desc_edit->assessment_id)}}">
                                              {{ csrf_field() }}
                                                    <div class="form-group row">
                                                        <label class="col-sm-2 col-form-label">First Name:</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control form-control-normal" name="trainee_name" id="name" value="{{ $res_desc_edit->trainee_name }}" required="" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-sm-2 col-form-label">Middle Name:</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control form-control-normal" name="trainee_middlename" value="{{ $res_desc_edit->trainee_middlename }}" required="" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-sm-2 col-form-label">Last Name:</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control form-control-normal" name="trainee_lastname" value="{{ $res_desc_edit->trainee_lastname }}" required="" placeholder="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control " name="assessment_cn"  value="{{ $res_desc_edit->assessment_cn }}" required="" placeholder="">
                                                            </div>
                                                        </div>
