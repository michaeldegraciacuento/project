...
<head>
    <title>TESDA Regional Training Center </title>
            ...
            <div class="pcoded-wrapper"></div>
                <nav class="pcoded-navbar">
                    <div class="pcoded-inner-navbar main-menu">
                        ...
                        <li class="">
                            <a href="{{URL::to('/editskills')}}">
                                <span class="pcoded-micon"><i class="feather icon-file-plus"></i></span>
                                <span class="pcoded-mtext">Language Skills Institute</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="{{URL::to('/editquali')}}">
                                <span class="pcoded-micon"><i class="feather icon-file-plus"></i></span>
                                <span class="pcoded-mtext">Registered Qualification</span>
                            </a>
                        </li>
                        <li class="">
                        ...
                        <li class="">
                            <a href="{{URL::to('/alumnipeps')}}">
                                <span class="pcoded-micon"><i class="feather icon-file-plus"></i></span>
                                <span class="pcoded-mtext">RTC Alumni</span>
                            </a>
                        </li>
                
                        
                        <li class="">
                            <a href="{{URL::to('/comquali')}}">
                                <span class="pcoded-micon"><i class="feather icon-file-plus"></i></span>
                                <span class="pcoded-mtext">Comm-based Qualifications</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="{{URL::to('/editassessor')}}">
                                <span class="pcoded-micon"><i class="feather icon-file-plus"></i></span>
                                <span class="pcoded-mtext">Accredited Assessors</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="{{URL::to('/editresult')}}">
                                <span class="pcoded-micon"><i class="feather icon-file-plus"></i></span>
                                <span class="pcoded-mtext">Assessments Results</span>
                            </a>
                        </li>
                       
                        <li class="">
                            <a href="{{URL::to('/editschedule')}}">
                                <span class="pcoded-micon"><i class="feather icon-file-plus"></i></span>
                                <span class="pcoded-mtext">Assessments Schedule</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="{{URL::to('/editaccass')}}">
                                <span class="pcoded-micon"><i class="feather icon-file-plus"></i></span>
                                <span class="pcoded-mtext">Accredited Assessments</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="{{URL::to('/nau')}}">
                                <span class="pcoded-micon"><i class="feather icon-file-plus"></i></span>
                                <span class="pcoded-mtext">News And Updates</span>
                            </a>
                        </li>
