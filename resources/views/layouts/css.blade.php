            ...
            <div class="pcoded-wrapper"></div>
                <nav class="pcoded-navbar">
                    <div class="pcoded-inner-navbar main-menu">
                        ...
                        <li class="">
                            <a href="{{URL::to('/pdflink')}}">
                                <span class="pcoded-micon"><i class="feather icon-file-plus"></i></span>
                                <span class="pcoded-mtext">PDF Link</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="{{URL::to('/csssendlink')}}">
                                <span class="pcoded-micon"><i class="feather icon-file-plus"></i></span>
                                <span class="pcoded-mtext">Assessment Link</span>
                            </a>
                        </li>
                    
                        <li class="">
                            <a href="{{URL::to('/csspretestresult')}}">
                                <span class="pcoded-micon"><i class="feather icon-file-plus"></i></span>
                                <span class="pcoded-mtext">Pre Test Result</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="{{URL::to('/cssposttestresult')}}">
                                <span class="pcoded-micon"><i class="feather icon-file-plus"></i></span>
                                <span class="pcoded-mtext">Post Test Result</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="{{URL::to('/assresult')}}">
                                <span class="pcoded-micon"><i class="feather icon-file-plus"></i></span>
                                <span class="pcoded-mtext">Assessment Result</span>
                            </a>
                        </li> 
                        <li class="">
                            <a href="{{URL::to('/addAdminAcc')}}">
                                <span class="pcoded-micon"><i class="feather icon-file-plus"></i></span>
                                <span class="pcoded-mtext">Add Admin Account</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="{{URL::to('addTraineeAcc')}}">
                                <span class="pcoded-micon"><i class="feather icon-file-plus"></i></span>
                                <span class="pcoded-mtext">Add Trainee Account</span>
                            </a>
                        </li>
