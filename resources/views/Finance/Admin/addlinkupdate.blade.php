...
$(document).ready(function () {
    ...
    $("#addrow").on("click", function () {
        var newRow = $("<tr>");
        var cols = "";        
        cols += '<td width="10%"><input type="text" class="form-control" name="linkupdate_year[]' + counter + '"/></td>';
        cols += '<td><input type="text" class="form-control"  name="linkupdate_date[]' + counter + '"/></td>';
            ...
            <div class="page-wrapper">
                    <div class="page-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                <form method="post" action="{{ URL::to('/eaddlinkupdate')}}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                        ...
                                        <div class="dt-responsive table-responsive" >
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td width="50%" >
                                                        <input width="100%" height="100%" type="text"id="name" value="" required name="linkupdate_headrep"  class="form-control"/>
                                                    </td>
                                                </tr>
                                            </thead>
                                            <thead>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td width="10%" height="10">
                                                        <input width="100%" height="100%" type="text" id="name" value=""name="linkupdate_year[]" class="form-control"/>
                                                    </td>
                                                    <td width="10%" >
                                                        <input type="text" id="name" value="" name="linkupdate_date[]" class="form-control"/>
                                                    </td>
                                                    <td width="80%" >
