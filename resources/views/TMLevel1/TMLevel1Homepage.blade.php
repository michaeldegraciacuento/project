                                ...
                                <div class="main-menu   d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a href="{{ URL::to('/partners') }}">TMLevel1</a>
                                            <li><a>Training Requirements<i class="ti-angle-down"></i></a>
                                                   <ul class="submenu">
                                                <li><a href="{{ URL::to('/trainingschedule1') }}">Training Calendar</a></li>
                                               
                                                    <li><a href="{{ URL::to('/activitymatrix1') }}">Activity Matrix</a></li>
                                                    <li><a href="{{ URL::to('/achievementssheets1') }}">Achievement Chart</a></li>
                                                    <li><a href="{{ URL::to('/progresssheets1') }}">Progress Chart</a></li>
                                                
                                                    <li><a href="{{ URL::to('/iar1') }}">Institutional Assessment Schedule</a></li>
                                                    <li><a href="{{ URL::to('/iar1') }}">Institutional Self Assessment Guide</a></li>
                                                    <li><a href="{{ URL::to('/iar1') }}">Templates</a></li>
                                                    <li><a href="{{ URL::to('/iar1') }}">TR</a></li>
                                                    <li><a href="{{ URL::to('/iar1') }}">CB</a></li>
                                                </ul>
