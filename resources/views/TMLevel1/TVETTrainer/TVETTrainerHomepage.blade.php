...
<head>
    ...
    <title>RTC-Iligan | Computer Systems Servicing NC II</title>
                            ...
                            <div class="header_right d-flex">
                                    <div class="short_contact_list">
                                            <ul>
                                                ...
                                                <li><a > <i class="fa fa-phone"></i>[63] 224-0090</a></li>
                                            </ul>
                                            <ul>
                                              
                                                <li><a href="{{URL::to('/trainee/login')}}">Trainee's Login</a></li>
                                            </ul>
                                        </div>
                    ...
                    <div class="header_bottom_border">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6 col-lg-7 ">
                                ...
                                <nav>
                                    <ul id="navigation">
                                            <li><a href="{{ URL::to('/TVETTrainerHomepage') }}">Home <i class="ti-angle-down"></i></a>
                                                <ul class="submenu">
                                                    <li><a href="{{ URL::to('/tmgallery') }}">Gallery</a></li>
                                                    <li><a href="{{ URL::to('/tmaccomplishment') }}">Accomplishment Reports</a></li>
                                                </ul>
                                            </li>
                                            <li><a >About<i class="ti-angle-down"></i></a>
                                                <ul class="submenu">
                                                  <li><a href="{{ URL::to('/tmprofile') }}">Profile</a></li>
                                                  <li><a href="{{ URL::to('/tmvmo') }}">Vision, Mission & Objectives</a></li>
                                            ...
                                            <li><a>Training Requirements<i class="ti-angle-down"></i></a>
                                                   <ul class="submenu">
                                                <li><a href="{{ URL::to('/tmtc') }}">Training Calendar</a></li>
                                               
                                                    <li><a href="{{ URL::to('/tmam') }}">Activity Matrix</a></li>
                                                    <li><a href="{{ URL::to('/tmac') }}">Achievement Chart</a></li>
                                                    <li><a href="{{ URL::to('/tmpc') }}">Progress Chart</a></li>
                                                
                                                    <li><a href="{{ URL::to('/tmias') }}">Institutional Assessment Schedule</a></li>
                                                    <li><a href="{{ URL::to('/tmisag') }}">Institutional Self Assessment Guide</a></li>
                                                    <li><a href="{{ URL::to('/tmtmeplates') }}">Templates</a></li>
                                                    <li><a href="{{ URL::to('/tmtr') }}">TR</a></li>
                                                    <li><a href="{{ URL::to('/tmcb') }}">CB</a></li>
                                                </ul>
                                                <li><a>Others<i class="ti-angle-down"></i></a>
                                                   <ul class="submenu">
                                                <li><a href="{{ URL::to('/tmcblm') }}">CBLM</a></li>
                                               
                                                    <li><a href="{{ URL::to('/') }}">Pre-Test</a></li>
                                                    <li><a href="{{ URL::to('/') }}">Pre-Test Result</a></li>
                                                    <li><a href="{{ URL::to('/') }}">Post-Test</a></li>
                                                    <li><a href="{{ URL::to('/') }}">Post-Test Result</a></li>
                                                    <li><a href="{{ URL::to('/') }}">Institutional Assessment</a></li>
                                                    <li><a href="{{ URL::to('/') }}">Institutional Assessment Result</a></li>
                                                </ul>
                                        </ul>
                                    </nav>
                                </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-10 offset-xl-1">
                                <div class="slider_text text-center justify-content-center">
                                    <h3>Trainers Methodlogy Level I</h3>
                                 <p>A person who has achieved this qualification is competent to be a TVET Trainer / Technical Trainer, Training Facilitator / Coordinator and Competency Assessor.</p>
                                    </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="container">
                    <div class="col-xl-12">
                        ...
                        <br><br> <br><br>
                        <h2><span>Trainers Methodlogy Level I Accomplisment Reports</span></h2>
                        <h5>AO 2015 - 2017</h5>
