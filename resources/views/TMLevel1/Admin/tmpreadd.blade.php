                            ...
                            <div class="page-wrapper">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h5>Add Pre Assessment Result</h5>
                                         
                                                
                                            </div>
                                            <div class="card-block">
                                            <form method="post" action="{{ URL::to('/tmaddprefunctions')}}">
                                            {{ csrf_field() }}
                                                    <div class="form-group row">
                                                        <label class="col-sm-2 col-form-label">Trainee Name</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control form-control-normal" name="tmpre_traineename" id="name" required="" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
