                    ...
                    <div class="row">
                        <div class="col-xl-5 col-md-5 ">
                            <div class="header_left">
                              <img src="{{asset('demos/teamcmdb/logo.png')}}" alt="">
                            </div>
                        </div>
                            ...
                            <div class="header_right d-flex">
                                    <div class="short_contact_list">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="{{URL::to('/trainee/login')}}"> <i class="fa fa-phone"></i>LOGIN TRAINEE</a></li>
                                            </ul>
                                        </div>
                                    ...
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a>Training Requirements<i class="ti-angle-down"></i></a>
                                                <ul class="submenu">
                                                    <li><a href="{{ URL::to('/schedules') }}">Training Schedule</a></li>
                                                    <li><a href="{{ URL::to('/attSheets') }}">Attendance Sheets</a></li>
                                                    <li><a href="{{ URL::to('/actMatrix') }}">Activity Matrix</a></li>
                                                    <li><a href="{{ URL::to('/achieveSheets') }}">Achievement Sheets</a></li>
                                                    <li><a href="{{ URL::to('/progSheets') }}">Progress Sheets</a></li>
                                                    ...
                                                    <li><a href="{{ URL::to('/houseSched') }}">Housekeeping Schedule</a></li>
                                                    <li><a href="{{ URL::to('/ems') }}">Equipment Maintenance Schedule</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="{{ URL::to('/partners') }}">Industrial Partners </a>
                                        </ul>
                                    </nav>
                                </div>
                            </div>
