                        ...
                        <div class="main-body">
                            <div class="page-wrapper">
                                        ...
                                        <div class="card">
                                            ...
                                            <form method="post" action="{{ URL::to('/addprefunctions')}}">
                                            {{ csrf_field() }}
                                                    <div class="form-group row">
                                                        <label class="col-sm-2 col-form-label">Trainee Name</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control form-control-normal" name="pre_traineename" id="name" required="" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
