...
$(document).ready(function() {
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Month', 'ENROLLED', 'GRADUATE', 'ASSESSED', 'CERTIFIED', 'EMPLOYMENT'],
            ['2015', 119, 108, 108, 98, 24],
            ['2016', 49, 48, 48, 45, 9],
            ['2017', 57, 57, 57, 55, 16]
    ...
    // CSS Landing Page
    google.charts.load('current', { 'packages': ['corechart'] });
    google.charts.setOnLoadCallback(cssLanding);
    ...
    function cssLanding() {
        ...
        var chart = new google.visualization.ComboChart(document.getElementById('css_landing'));
        chart.draw(data, options);
    }

    // TESDA Main Page
    google.charts.load('current', { 'packages': ['corechart'] });
    google.charts.setOnLoadCallback(tesdaMain);

    function tesdaMain() {
        // Some raw data (not necessarily accurate)
        var data = google.visualization.arrayToDataTable([
            ['Year', 'ENROLLED', 'GRADUATE', 'ASSESSED', 'CERTIFIED', 'EMPLOYED'],
            ['2016', 2956, 2570, 2543, 2161, 438],
            ['2017', 3169, 2408, 2237, 2115, 1193],
            ['2018', 3697, 3412, 6688, 6244, 120],
            ['2019', 3579, 2932, 5965, 5802, 380]
        ]);
        ...
        var chart = new google.visualization.ComboChart(document.getElementById('tesda_main'));
        chart.draw(data, options);
    }
